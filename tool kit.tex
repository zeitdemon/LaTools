...
\newcommand{\hfw}{\tx{\color{RubineRed} $\star$hier fehlt was$\star$ }}  % used to indicate to the reader that something is missing here
...
\newcommand{\folie}[1]{\tx{\color{gray}[Folie: #1]}}  % used to tell the reader that there was multimedia content during a lecture
\newcommand{\versuch}[1]{\textbf{\color{red!50!black}Versuch:} \textbf{#1}\\ }  % used to tell the reader that there was a live experiment
...
\newcommand{\lcom}[1]{\tx{\color{MidnightBlue}#1}}  % used to indicate to the reader that this content was transcribed from the lecture
